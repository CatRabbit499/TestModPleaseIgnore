...
public interface IProxy
{
    ...
    /**
     * Fml life cycle event for Initialization. This phase is valid for registering event listeners, for registering things that depend on things in pre-init from other mods (like
     ...
     * mods like having a list of all registered item to aid random item generation.
     *
     * @param event the event
     */
